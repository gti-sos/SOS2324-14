...
const mediaSegundosRestantes = Math.round(mediaSegundos % 60);

console.log('La media de tiempo empleado en cada pelea es de ', mediaMinutos, ' minutos y ', mediaSegundosRestantes, ' segundos.');