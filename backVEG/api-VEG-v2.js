...
function api_VEG_v2(app, db) {
    ...
    app.get(API_BASE + "/youtube-trends/docs", (req, res) => {
        res.status(301).redirect("https://documenter.getpostman.com/view/33038536/2sA3JNc1X4")
    });

    // Proxy BasketVEG
    app.use(API_BASE + "/youtube-trends/proxyBasketVEG", function (req, res) {
